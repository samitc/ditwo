...
createType(int32, signed
		int, 4);
createType(int16, signed
		short, 2);
createType(int64, signed
long
		long, 8);
createType(int8, signed
		char, 1);
createType(uint32, unsigned
		int, 4);
createType(uint16, unsigned
		short, 2);
createType(uint64, unsigned
long
		long, 8);
createType(uint8, unsigned
		char, 1);
using intp = uint32;
#endif